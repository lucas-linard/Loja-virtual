...
export default function Header({ loggedIn = false, onSearchChange, searchValue }) {
        ...
        <Toolbar>
          ...
          >
            <StyledSearch>
              <StyledInputBase
                ...
                sx={{ width: "100%" }}
                endAdornment={
                  <IconButton size="large" edge="end" color="inherit" sx={{ marginRight: "0em" }}>
                    <Search />
                  </IconButton>
                }
              />
          ...
          <Box sx={{ display: "flex", alignItems: "center", mr: 0 }}>
            ...
            {!loggedIn ? <>
              ...
              <IconButton color="inherit" onClick={() => router.push("SignUp")}>
                <Typography variant="body1" sx={{ fontWeight: "bold" }}>
                  Criar conta
                </Typography>
              </IconButton>
            ...
            <IconButton color="inherit" sx={{ marginLeft: 5 }}>
